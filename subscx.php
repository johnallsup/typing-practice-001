...
if($a && file_exists("sources/$a")) {
    ...
    include("substrs.php");
    $source = substrsx($source,"make_choices_Caps1");
    include("e.php");
} else {
    echo "<!DOCTYPE html>
<html>
<head>
<meta charset='utf-8'/>
<title>Simple Typing Practice - Substring practice - Caps and Punctuation</title>
<link rel='stylesheet' href='exp5idx.css' />
</head>
<body>
<h1>Substring practice - Caps and Punctuation</h1>
