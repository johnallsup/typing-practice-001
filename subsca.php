...
if($a && file_exists("sources/$a")) {
    ...
    include("substrs.php");
    $source = substrs($source,"make_choices_Caps2");
    include("e.php");
} else {
    echo "<!DOCTYPE html>
<html>
<head>
<meta charset='utf-8'/>
<title>Simple Typing Practice - Substring practice - Caps and ALL CAPS</title>
<link rel='stylesheet' href='exp5idx.css' />
</head>
<body>
<h1>Substring practice - Caps and ALL CAPS</h1>
